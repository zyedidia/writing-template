...
define(`arrester',
 `define(`m4rdna',`patsubst(`$2',D\|L\|R)')dnl
  ...
  define(`m4wd',
   `ifinstr(Loopover_(`Z',`ifinstr(m4rdna,Z,T)',C,F),T,
     `m4Leftstr(`$3',dimen_/3)',
    ifinstr(m4rdna,s,T),T, `m4Leftstr(`$3',dimen_/4)',
    ifinstr(m4rdna,E,T),T, `m4Leftstr(`$3',dimen_*5/8)',
